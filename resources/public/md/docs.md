...
Two middleware functions are provided by default in the `detra.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `detra.handler` namespace to manage the enabled middleware.
